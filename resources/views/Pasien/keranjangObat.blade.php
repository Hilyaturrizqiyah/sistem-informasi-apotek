                            ...
                            @if(!empty($pemesanan))
                                <table class="table">
                                    ...
                                    @foreach($pemesanan_detail as $pemesanan_detail)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td><img src="{{ url('admin/assets/images/obat/'.$pemesanan_detail->obat->foto) }}" class="rounded mx-auto d-block img-fluid" ></td>
                                            ...
                                            <td>
                                            <form action="{{ url('Pasien/keranjangObat') }}/{{ $pemesanan_detail->id_detail_pemesanan }}" method="post">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
                ...
                <div class="col-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if(!empty($pemesanan))
                            <form action=" {{ url('/add-konfirmasi')}}/{{ $pemesanan->id_pemesanan }} " method="post" enctype="multipart/form-data">
                            @csrf
                            <table class="table ">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><input class="form-control" type="number" name="no_telepon" value="{{$pemesanan->pasien->no_telepon}}" required><small>*Isi dengan Nomor Handphone yang masih aktif</small></td>
                                </tr>
                            </table>
