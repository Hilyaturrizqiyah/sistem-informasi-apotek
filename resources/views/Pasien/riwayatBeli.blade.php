            ...
            <nav class="site-navigation text-right " role="navigation">
                ...
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                    ...
                    <li class="nav-item dropdown"><?php
                        ...
                        ?>
                            <a href="{{ url('Pasien/riwayatBeli') }}" class="nav-link"><i class="fas fa-bell"></i>
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownpro">
                                @if(!empty($notifikasi))
                                <a href="{{ url('Pasien/riwayatBeli') }}" class="dropdown-item"><span class="badge badge-warning">{{$notifikasi}}</span> Pesanan Belum Dibayar</a>
                                @elseif(!empty($notifikasi2 ))
                                <a href="{{ url('Pasien/riwayatBeli') }}" class="dropdown-item"><span class="badge badge-danger">{{$notifikasi2}}</span> Pesanan Dibatalkan</a>
                                @else
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownpro">
                            <center>
                            <a href="{{ url('/Pasien/riwayatBeli') }}" class="dropdown-item text-white"><i class="fas fa-list-ul"></i> Riwayat</a>
                        ...
                        @foreach($pemesanan as $pemesanan)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-success"> Selesai <i class="fa fa-check-circle"></i></span>
                                    @else
                                    <span class="badge badge-danger"><i class="fa fa-exclamation-triangle"></i> Dibatalkan <i class="fa fa-exclamation-triangle"></i></span>
                                    @endif
                                </td>
                                <td>
