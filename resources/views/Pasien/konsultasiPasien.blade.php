...
<div class="site-wrap"  id="home-section">
                    ...
                    <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownpro">
                                ...
                                <a href=# class="dropdown-item"><i class="fas fa-list-ul"></i> Riwayat Konsultasi</a>
    ...
    <div class="row mb-4">
            ...
            <div class="mb-2">
                <a href="{{ url('/Pasien/KirimPertanyaan') }}" class="btn btn-primary text-black py-2 px-3" >Kirim Pertanyaan</a>
            </div>
            </div>
        </div>
        <center>
        <div class="section-title col-md-12 mb-1">
            <form action="/Pasien/konsultasiPasien/cari" method="GET">
                <input class="btn btn-light col-10" type="text" name="cari" placeholder="Cari konsultasi dengan nama obat / keluhan (Contoh : Paracetamol, Pusing)" value="{{ old('cari') }}" style="box-shadow: 2px 5px rgba(128, 128, 128, 0.247);">
        ...
        <div class="col-lg-6 col-md-4 mb-4 mb-lg-4" data-aos="fade-up">
            <div class="block-team-member-1 text-left rounded">
                        <h5><strong>{{$konsul->Pasien->nama}}</strong></a></h5><hr>
                        <a href="{{url('/Pasien/jawabanKonsultasi'.$konsul->id_konsultasi) }}" style="color: black" class="px-3 mb-3 mt-7">{{ \Str::limit($konsul->pertanyaan, 50) }}</a><br><hr>
                        @if(isset($konsul->jawaban))
                            <span class="badge badge-success">Sudah dijawab oleh apoteker...</span>
                        @else
