        ...
        <div class="row align-items-center position-relative">
            ...
            <nav class="site-navigation text-right " role="navigation">
                ...
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                    <li><a href="{{ url('/Pasien/DashboardPasien') }}" class="nav-link active">Pemesanan Obat</a></li>
    ...
    <div class="card" >
        ...
        <div class="row">
            <div class="col-md-7 mt-5">
                ...
                <table class="table">
                <form method="post" id="form1" name="form1" action="{{ url ('Pasien/AksiKirim') }}">
                {{csrf_field()}}
                    <thead>
                        <tr>
                            ...
                            <td width="30px">:</td>
                            <td>
                                <textarea name="pertanyaan" class="form-control @error('pertanyaan') is-invalid @enderror"></textarea>
