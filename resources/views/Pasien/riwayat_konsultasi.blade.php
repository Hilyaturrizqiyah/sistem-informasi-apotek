                ...
                <H4>Riwayat Konsultasi</H4>
                    ...
                    <table class="table">
                        ...
                        @foreach($konsul as $konsul)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>{{ \Str::limit($konsul->pertanyaan, 30) }}</td>
                                <td>{{ $konsul->created_at }}</td>
                                <td>
                                    @if(isset($konsul->jawaban))
                                    {{ \Str::limit($konsul->jawaban, 30) }}
                                    @else
                                    <span class="badge badge-danger">belum dijawab apoteker</span>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{url('/Pasien/jawabanKonsultasi'.$konsul->id_konsultasi) }}" class="btn btn-primary"><i class="fa fa-info"></i> Detail</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
