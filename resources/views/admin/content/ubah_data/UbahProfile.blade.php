...
<form enctype="multipart/form-data" class="contact-form-area contact-page-form contact-form text-left" action="AksiUbahProfile{{$datas->id_admin}}" method="post">
                    ...
                    <table>
                      <tr>
                        ...
                        <td width="250"><label><b>Nama ApoAdminteker Baru</b></label></td>
                      </tr>
                      <tr>
