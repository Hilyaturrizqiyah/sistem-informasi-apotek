            ...
            <!-- Form Basic -->
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <form enctype="multipart/form-data" action="{{url('admin/AksiTambahObat')}}" method="post">

                    {{csrf_field()}}

                    <div class="form-group">
                      <label><b>Id Obat</b></label>
                      <input type="text" class="form-control" name="id_obat" placeholder="Masukkan Id Obat">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="harga_modal" placeholder="Masukkan Harga Modal">
