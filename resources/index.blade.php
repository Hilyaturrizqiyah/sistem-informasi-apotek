      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-4 mb-lg-0" data-aos="fade-up">
            ...
            <span class="d-block font-gray-5 letter-spacing-1 text-uppercase font-size-12 mb-3">{{$dokter->jenis_dokter}}</span>
            <p class="px-3 mb-3">
                <h5>Jadwal Praktek</h5>
                @foreach($jadwals as $jadwal)
                <span>@if ($jadwal->hari == '1')
                        Senin
                      ...
                      @elseif ($jadwal->hari == '7')
                        Minggu
                      @endif 
                      : {{$jadwal->waktu_mulai}} - {{$jadwal->waktu_selesai}}</span> <br>
                @endforeach
            </p>
          ...
          <div class="col-lg-6">
            <div class="block-team-member-1 text-left rounded" style="border: 5px solid grey; width: 400px;">
              ...
              <p class="px-3 mb-4 mt-3">
                    ...
                    <h1 style="color: green">B01</h1> <br>
              </p></center>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <form action="{{ url('/formAntrianPost') }}" method="post">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <select name="dokter" id="select" class="form-control">
                      <option value="">Pilih Dokter</option>
                      @foreach($dokters as $dokter)
                      <option value="{{$dokter->id_praktik}}">{{$dokter->jenis_dokter}}</option>
                      @endforeach
                  </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                      ...
                      <small>*Masukan nama pasien yang akan berobat</small>
                    </div>
                  </div>
                <div class="form-group row">
                    <div class="col-md-12">
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      <textarea id="alamat" class="form-control" name="alamat" placeholder="Alamat Lengkap" cols="30" rows="10"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6 ml-auto">
                      <input type="submit" class="btn btn-block btn-primary text-white py-3 px-5" value="Ambil Antrian">
                    </div>
                  </div>
            </form>
          </div>
